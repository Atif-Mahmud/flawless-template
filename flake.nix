{
  ...
  inputs = {
    ...
    flawless.url = "github:Atif-Mahmud/flawless";
  ...
  outputs = { self, nixpkgs, crane, fenix, flake-utils, advisory-db, flawless, ... }:
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = craneLib.devShell {
          ...
          packages = [
            flawless.packages.${system}.flawless
            pkgs.cargo-hakari
          ];
        };
      });
